...
/*
 * Author: Mark Maillet
 * Abstract: This class provides CheckoutConfirm database methods
 */
    public class CheckoutConfirmDB
    {
        // Using this enum for generating a random bookin number
            ...
            try
            {
                using (SqlConnection conn = TravelExpertsDB.GetConnection())
                {
                    ...
                    for (int i = 0; i < ps.Count; i++)
                    {
                        ...
                        // Default travelercount = 2
                        // Default triptypeid = "L"
        ...
        //
        // Returns package with specified packageid
        // Includes the list of products and the supplier for the product
        //
        ...
        // Returns just the list of products and respective supplier for a specified package
